...
#
# pull.sh is gitignored — it shares server credentials with deploy.sh.
# ---------------------------------------------------------------------------

SSH_USER="your-user"                     # SSH username on the server
SSH_HOST="your-server.com"               # server hostname or IP
REMOTE_PATH="/home/your-user/your-domain.com"  # absolute path to the site root on the server
